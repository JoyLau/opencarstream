...
description: "Search and extract video data from Bilibili homepage or search results, then save to local API. Use when: user wants to get Bilibili video information and save to database. Supports keyword search on homepage or direct extraction from current page. Automatically posts data to http://192.168.1.27:33333/bili_videos_fill"
---
